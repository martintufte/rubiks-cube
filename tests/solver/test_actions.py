...
def test_get_actions_standard_moves() -> None:
    ...
    actions = get_action_space(generator=generator, expand=False, cube_size=cube_size)
    assert len(actions) == 6

    actions_expanded = get_action_space(generator=generator, cube_size=cube_size)
